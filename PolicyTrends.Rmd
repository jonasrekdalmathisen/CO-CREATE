...
pacman::p_load(reactable, tidyverse, readxl, lubridate, timelineS)
```
...
Norway_time %>% group_by(`NOURISHING LETTER`) %>% summarise_at(vars(`IMPLEMENTATION YEAR`), list(name= median))
