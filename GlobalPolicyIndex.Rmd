...
#library multiple import
pacman::p_load(countrycode, eurostat, COINr, pheatmap, tidyverse)
...
#PolicyDims
PolicyDims <- policydb %>% distinct(PolicyDim,PolicyAreaID)
